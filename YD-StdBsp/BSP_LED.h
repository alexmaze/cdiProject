...
#define LED2_OFF                       GPIOC->BRR = 0x02 //GPIO_SetBits(GPIOC,GPIO_Pin_1)
#define LED2_ON                        GPIOC->BSRR = 0x02//GPIO_ResetBits(GPIOC,GPIO_Pin_1)
#define LED2_TURN                      GPIOC->ODR ^= 0x02
