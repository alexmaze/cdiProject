...
{    
	...
	Serial_strRead(ESP8266_Frame.RX_BUF,timeout);                //延时
	  
	if((reply1 != 0) &&(reply2 != 0))
		return((bool) strstr(ESP8266_Frame.RX_BUF, reply1) ||(bool) strstr(ESP8266_Frame.RX_BUF, reply2)); 
 	
	else if(reply1 != 0)
		return((bool) strstr(ESP8266_Frame.RX_BUF, reply1));
	
	else
		return((bool) strstr(ESP8266_Frame.RX_BUF, reply2));
