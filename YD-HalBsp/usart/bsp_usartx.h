...
// 串口DMA相关
#define USARTx_DMAx_CHANNELn                   DMA1_Channel4
#define USARTx_RCC_DMAx_CLK_ENABLE()           __HAL_RCC_DMA1_CLK_ENABLE()
#define USARTx_DMAx_CHANNELn_IRQn              DMA1_Channel4_IRQn
#define USARTx_DMAx_CHANNELn_IRQHANDLER        DMA1_Channel4_IRQHandler
