...
typedef struct ESP8266{
    __IO char* ucResponse;
    __IO char ucLineBuf[100];
    __IO uint8_t ucReceivedMode;
    __IO uint8_t ucEndFlag;
}__ESP8266_T;
...
void ESP8266_WaitMsg (char* _pcResponse, TickType_t _ucTimeOut, const uint8_t _ucMode);
char* ESP8266_GetExceptStr (void);
void ESP8266_GetLineStr (char* _pcLineStr, uint8_t _ucStrLen);
void ESP8266_SetEndFlag (void);
uint8_t ESP8266_GetMode (void);
